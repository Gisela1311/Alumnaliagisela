...
class Dat_Per(models.Model):
    ...
    # fk_nom_pro = models.ForeignKey(Provincias, on_delete=models.CASCADE, verbose_name="Provincia", null=True) 
    # fk_nom_mun = models.ForeignKey(Municipios, on_delete=models.CASCADE, verbose_name="Municipio", null=True)
